...
<?php foreach ($records as $record): ?>
            ...
            <div class="blog-post">
                <h2 class="blog-post-title"><a href="/article.php?id=<?php echo $record->getId(); ?>">
                        <?php echo $record->getTitle(); ?></a></h2>
                <p class="blog-post-meta"><?php echo $record->getDate(); ?>
                    by <a href="#"><?php echo $record->getAuthor(); ?></a></p>
                <?php echo mb_substr($record->getText(), 0 ,600); ?>
            </div><!-- /.blog-post -->
